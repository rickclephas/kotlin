...
dependencies {
    ...
    embedded(commonDependency("org.jetbrains.intellij.deps:asm-all"))
    embedded(commonDependency("com.google.code.gson:gson"))
    embedded(commonDependency("com.google.guava:guava"))
    embedded(commonDependency("org.jetbrains.teamcity:serviceMessages"))
