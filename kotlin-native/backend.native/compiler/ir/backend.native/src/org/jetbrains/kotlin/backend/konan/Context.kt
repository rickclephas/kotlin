...
internal class InlineFunctionInfo(val irFunction: IrFunction, val irFile: IrFile, val startOffset: Int, val endOffset: Int)
...
internal class SpecialDeclarationsFactory(val context: Context) {
    ...
    val loweredInlineFunctions = mutableMapOf<IrFunction, InlineFunctionInfo>()
...
internal class Context(config: KonanConfig) : KonanBackendContext(config) {
    ...
    var irLinker: KonanIrLinker? = null
